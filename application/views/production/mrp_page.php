        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="col-7 text-right">
             <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>production/mrp/newmrp"><i class="fa fa-calendar-plus"></i> MRP Baru</a>
           </div>
         </div>
         <br>
         <div class="card-body">
...
<script>
  ...
  function searchFilter(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>production/mrp/ajaxPaginationData/'+page_num,

      ...
      <div class="col-12">
        <div class="card">
          ...
          <?php if (!empty($material_edit->mv_option)) { ?>
            ...
            <form action="<?php echo site_url('production/item_material/editprocess')?>" method="post" enctype="multipart/form-data" >
             <div class="card-body">
               <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="inputEmail4">Item Material /w varian</label>

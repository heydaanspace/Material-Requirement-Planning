    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="<?php echo site_url('production/product_card/addproductcard') ?>" method="post" enctype="multipart/form-data" >
            <div class="card-body">
              <div class="form-row">
...
<script>
  $(function () {
   $('#selectvarian').on('itemAdded', function(event) {
    var markup = '<tr id="'+ event.item + '"><td><input type="text" name="ivarianval[]" value="'+ event.item + '" class="form-control" readonly=""></td><td><input type="text" name="iproductsku[]" class="form-control"></td><td><input type="text" name="isalesprice[]" class="form-control"></td></tr>';
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function tampil_selcategory(){
      $.ajax({
        type  : 'GET',
        url   : '<?php echo base_url()?>production/product_card/showcategory',
        async : true,
        dataType : 'json',
    ...
    function tampil_selunit(){
      $.ajax({
        type  : 'GET',
        url   : '<?php echo base_url()?>production/product_card/showunit',
        async : true,
        dataType : 'json',
        success : function(data){
          var html = '';
    ...
    function tampil_mastervariant(){
      $.ajax({
        type  : 'GET',
        url   : '<?php echo base_url()?>production/product_card/showmastervariant',
        async : true,
        dataType : 'json',
        success : function(data){
          var html = '';
...
$('#save_category').on('click',function(){
  ...
  $.ajax({
    type : "POST",
    url  : "<?php echo base_url('production/product_card/addcategory')?>",
    dataType : "JSON",
...
$('#save_unit').on('click',function(){
  ...
  $.ajax({
    type : "POST",
    url  : "<?php echo base_url('production/product_card/addunit')?>",
    dataType : "JSON",
    data : {iuom:iuom},
    success: function(data){
      $('[name="iuom"]').val("");
...
$('#save_variant').on('click',function(){
  ...
  $.ajax({
    type : "POST",
    url  : "<?php echo base_url('production/product_card/addmastervariant')?>",
    dataType : "JSON",

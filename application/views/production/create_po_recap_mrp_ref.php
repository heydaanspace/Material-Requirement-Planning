    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="<?php echo site_url('production/purchase_order/saveporecapmrp') ?>" method="post" enctype="multipart/form-data" >
            <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-2">
                  ...
                  <input type="hidden" id="icreate_date" name="icreate_date" value="<?= date('Y-m-d')?>">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label>Rujukan Produksi</label><br>
              ...
              <div class="card-body p-0" id="productMRP">
               ...
               <div class="table-responsive">
                 <table id="tbvarian" class="table table-bordered">
                  ...
                  <td>
                    <input type="text" class="form-control iqty_po amount" name="iqty_po[]" value="<?= $dataPO->qtyporel; ?>" id="iqty">
                  </td>
                  <td>

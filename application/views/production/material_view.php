        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="col-8 text-right">
              <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>production/item_material/newmaterial">
...
<script>
  function searchFilter(page_num) {
   ...
   $.ajax({
    type: 'POST',
    url: '<?php echo base_url(); ?>production/item_material/ajaxPaginationData/'+page_num,

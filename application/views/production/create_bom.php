    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="<?php echo site_url('production/product_card/addbillofmaterial') ?>" method="post" enctype="multipart/form-data" >
            <div class="card-body">
              <div class="form-row">
          ...
          <div class="card-footer text-right">
            <a class="btn btn-light" href="<?php echo base_url(); ?>production/product_card">Batal</a> &nbsp;

    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php echo site_url('production/report/printmrpreport') ?>" method="post" enctype="multipart/form-data" >
              <div class="form-row">
...
<script type="text/javascript">
  ...
  function filterMrpReport(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>production/report/ajaxMrpReport/'+page_num,

<section class="section">
  ...
  <p class="section-lead">
    <strong>Head Production | Admin.</strong>
   <div class="row">
    <div class="col-md-12">
      <div class="card">
          ...
          <table class="table table-striped">
            ...
            <?php foreach ($manufacturing as $data):?>
              <tr>
                ...
                <td>
                  <a href="<?php echo base_url() ?>production/manufacturing/editmanufacturing/<?php echo $data->mo_id; ?>" class="btn btn-primary">Detail</a>
                </td>
              </tr>
            <?php endforeach; ?>

  ...
  <script type="text/javascript">
   $(document).ready(function() {
    ...
    {  
     $('#selmo_code').change(function(){ 
      ...
      $.ajax({
       type: 'POST',
       url: '<?php echo base_url(); ?>production/mrp/showitemproductmrp',
   ...
   {  
     $('#sel_prod').change(function(){ 
      ...
      $.ajax({
       type: 'POST',
       url: '<?php echo base_url(); ?>production/mrp/showdetmanufacturing',
   ...
   {  
    $('#sel_prod').change(function(){ 
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>production/mrp/showmaterial',

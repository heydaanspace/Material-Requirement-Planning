				...
				<td colspan="2">
					<table>
						<tr>
							...
							<td>
								<p style="font-size: 15px; color: #d46e2a;"><strong>LAPORAN STOK KELUAR</strong></p>
		...
		<table cellpadding="0" cellspacing="0" class="tb-border">
			...
			<?php if(!empty($report_stock)): foreach($report_stock as $data): ?>
				<tr>
					...
					<td style="text-align:center;"><?= $data['material_sku'];?></td>
					...
					<td>
						<div style="width: 100px;"><?= $data['stok_keluar'];?> <?php echo  $data['material_unit']; ?> <div style="width: 100px;"></div>
					</td>
					<td>
						<div style="width: 100px;">
							Rp. <?php 

<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url(); ?>production/mrp">MRP</a></div>
      <div class="breadcrumb-item">Detail MRP</div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="<?php echo site_url('production/mrp/savemrp') ?>" method="post" enctype="multipart/form-data" >
            <div class="card-body">
...
<div class="card-footer text-right">
  ...
  <a class="btn btn-success" href="<?php echo base_url() ?>production/purchase_order/newpo_mrp/<?= $mrp_data->mrp_id; ?>"><i class="fas fa-shopping-cart"></i> Buat Rujukan Pesanan Pembelian</a>
  <button onclick="deleteConfirm('<?php echo base_url() ?>production/mrp/actdeleteMRP/<?= $mrp_data->mrp_id; ?>')" class="btn btn-danger" type="button"><i class="fa fa-trash"></i> Hapus Draft MRP</button>
</div>
</form>
</div>
</div>

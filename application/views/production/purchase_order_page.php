          ...
          <div class="card-header">
            ...
            <div class="col-7 text-right">
              <div class="dropdown d-inline mr-2">
               <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>production/purchase_order/newpo"><i class="fa fa-plus-circle"></i> Pesanan Pembelian Baru</a>
          ...
          <table class="table table-striped">
            ...
            <?php foreach ($po_list as $data): ?>
             <tr>
              ...
              <td>
                <a href="<?php echo base_url() ?>production/purchase_order/showdetailPO/<?php echo $data['po_id']; ?>"><?= $data['po_code'] ?></a>
              </td> 
...
<script>
  ...
  function searchFilter(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>production/purchase_order/ajaxPaginationData/'+page_num,
  ...
  {
    $.ajax({
      url: "<?php echo site_url('production/purchase_order/showitemPO');?>",
      type: "POST",
      data: {po_id: po_id},

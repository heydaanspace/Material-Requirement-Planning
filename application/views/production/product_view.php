        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="col-8 text-right">
              <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>production/product_card/newproduct"><i class="fas fa-credit-card"></i> Kartu Produk Baru</a>
              <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>production/product_card/newbom"><i class="fas fa-cubes"></i> Tetapkan Struktur Produk</a>
              ...
              <table class="table table-striped">
                ...
                <?php if(!empty($product_card)): foreach($product_card as $product_card): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url() ?>production/product_card/editproductcard/<?php echo $product_card['product_code']; ?>">
                    ...
                    <td><a href="<?php echo base_url() ?>production/product_card/showdetailbom/<?php echo $product_card['sku_id']; ?>"><?php echo $product_card['product_sku']; ?></a></td>
                  ...
                  <td>
                    <div class="dropdown d-inline">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item has-icon" href="<?php echo base_url() ?>production/product_card/editproductcard/<?php echo $product_card['product_code']; ?>"><i class="fas fa-edit"></i>Ubah</a>
                        <a onclick="deleteConfirm('<?php echo base_url() ?>production/product_card/delproduct/<?php echo $product_card['product_code']; ?>')" class="dropdown-item has-icon" href="#!"><i class="fas fa-trash"></i> Hapus</a>
...
<script>
  ...
  function searchFilter(page_num) 
  {
   ...
   $.ajax({
    type: 'POST',
    url: '<?php echo base_url(); ?>production/product_card/ajaxPaginationData/'+page_num,
...
{
  $.ajax({
    url: "<?php echo site_url('production/product_card/showbom');?>",
    type: "POST",

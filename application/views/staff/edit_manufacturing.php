  ...
  <div class="section-body">
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="col-8 text-right">
            <a target="_blank" href="<?php echo base_url() ?>staff/manufacturing/pdfinvoicemo/<?= $mo_list->mo_id; ?>"><i class="fas fa-print"></i> Cetak Invoice</a>
          </div>
        </div>
        <form action="<?php echo site_url('staff/manufacturing/actupdateMO') ?>" method="post" enctype="multipart/form-data" >
          <div class="card-body">
      ...
      <div class="card-footer text-right">
        ...
        <button onclick="deleteConfirm('<?php echo base_url() ?>staff/manufacturing/actdeleteMO/<?= $mo_list->mo_id; ?>')" class="btn btn-danger" type="button"><i class="fa fa-trash"></i> Hapus Pesanan</button>

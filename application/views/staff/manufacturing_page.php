        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="col-8 text-right">
              <a class="btn btn-outline-primary" href="<?php echo base_url(); ?>staff/manufacturing/newmanufacturing"><i class="fa fa-calendar-plus"></i> Pesanan Produksi Baru</a>
                  ...
                  <?php if(!empty($manufacturing)): foreach($manufacturing as $data): ?>
                    <tr>
                      ...
                      <td><div style="width: 150px;">
                        <a href="<?php echo base_url() ?>staff/manufacturing/editmanufacturing/<?php echo $data['mo_id']; ?>"><?= $data['mo_code'];?></a>
                      </div></td>
                      ...
                      <td>
                        ...
                        <td>
                          <div class="dropdown d-inline">
                            ...
                            <div class="dropdown-menu">
                              <a onclick="UpdateStatus('<?php echo base_url() ?>staff/manufacturing/updatestatusstart/<?php echo $data['mo_id']; ?>')" class="dropdown-item has-icon" href="#!"><i class="fas fa-hourglass-start"></i>Mulai</a>
                              <a onclick="UpdateStatus('<?php echo base_url() ?>staff/manufacturing/updatestatusdone/<?php echo $data['mo_id']; ?>')" class="dropdown-item has-icon" href="#!"><i class="fas fa-check-circle"></i> Selesai</a>
                              <a onclick="UpdateStatus('<?php echo base_url() ?>staff/manufacturing/updatestatusreject/<?php echo $data['mo_id']; ?>')"class="dropdown-item has-icon" href="#!"><i class="fas fa-times-circle"></i> Batalkan</a>
                              <a onclick="UpdateStatus('<?php echo base_url() ?>staff/manufacturing/updatestatusnotstart/<?php echo $data['mo_id']; ?>')"class="dropdown-item has-icon" href="#!"><i class="fas fa-times-circle"></i> Belum dimulai</a>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="dropdown d-inline">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item has-icon" href="<?php echo base_url() ?>staff/manufacturing/editmanufacturing/<?php echo $data['mo_id']; ?>"><i class="fas fa-cog"></i>Ubah</a>
...
<script>
  ...
  function searchFilter(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>staff/manufacturing/ajaxPaginationData/'+page_num,
...
{
  $.ajax({
    url: "<?php echo site_url('staff/manufacturing/showitemproduct');?>",
    type: "POST",
    data: {mo_id: mo_id},

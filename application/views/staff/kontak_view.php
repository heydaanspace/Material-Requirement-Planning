						...
						<div class="col-8 text-right">
							<div class="dropdown d-inline mr-2">
								...
								<div class="dropdown-menu">
									<a class="dropdown-item" href="<?php echo base_url(); ?>staff/kontak/custfrm">Konsumen</a>
									<a class="dropdown-item" href="<?php echo base_url(); ?>staff/kontak/supfrm">Supplier</a>
								</div>
							</div>
							<div class="dropdown d-inline mr-2">
											...
											<tr>
												...
												<td>
													<div class="dropdown d-inline">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item has-icon" href="<?php echo base_url() ?>staff/kontak/editsupplier/<?php echo $supplier['supplier_id']; ?>"><i class="fas fa-cog"></i>Ubah</a>
															<a onclick="supdeleteConfirm('<?php echo base_url() ?>staff/kontak/delsupplier/<?php echo $supplier['supplier_id']; ?>')" class="dropdown-item has-icon" href="#!"><i class="fas fa-trash"></i> Hapus</a>
														</div>
													</div>
												</td>
											</tr>
...
<script>
	...
	function searchFilter(page_num) {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>staff/kontak/ajaxPaginationData/'+page_num,
	...
	function supsearchFilter(page_num) {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url(); ?>staff/kontak/supajaxPaginationData/'+page_num,

  <form class="form-inline mr-auto">
   ...
   <!--  <div class="search-element">
      <input class="form-control" type="search" placeholder="Tambah Data" aria-label="Search" data-width="250" readonly="">
  ...
  <ul class="navbar-nav navbar-right">
    ...
    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell"></i></a>
      <div class="dropdown-menu dropdown-list dropdown-menu-right">
        <div class="dropdown-header">Pemberitahuan
          <div class="float-right">
            <a href="#">Tandai pemberitahuan terihat</a>
          </div>
        </div>
    ...
    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
      ...
      <div class="d-sm-none d-lg-inline-block"><?= $userdata->fullname; ?></div></a>
      <div class="dropdown-menu dropdown-menu-right">
        <div class="dropdown-title">Terakhir masuk <p><?= tgl_lengkap($userdata->last_login); ?></p> </div>
        <a href="#" class="dropdown-item has-icon">
          <i class="far fa-user"></i> Akun
        </a>
        <a href="#" class="dropdown-item has-icon">
          <i class="fas fa-bolt"></i> Hak Akses
        </a>
        <a href="#" class="dropdown-item has-icon">

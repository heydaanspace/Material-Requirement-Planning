<section class="section">
  ...
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="<?php echo base_url(); ?>owner/manufacturing">Penanan Produksi</a></div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="<?php echo site_url('owner/purchase_order/savepo') ?>" method="post" enctype="multipart/form-data" >
            <div class="card-body">

...
<body>
	<div class="invoice-box">
					...
					<table>
						<tr>
							<td class="title">
								...
								<p style="font-size: 15px;"><strong style="color: #d46e2a;">DRAFT REKAP RENCANA PEMESANAN MATERIAL</strong>
								<i>(Planned Order Releases)</i></p>
							</td>
							<td>
		...
		<table>
			<tr>
				<td><p style="font-size: 16px;"><strong>Rinician Kebutuhan Bahan Baku</strong></p></td>
			</tr>
		</table>
		...
		<table cellpadding="0" cellspacing="0" class="tb-border">
			<tr class="header-table">
				...
				<th>Waktu Maksimal Pemesanan</th>
				<th>Jumlah harus dipesan</th>
			</tr>

                      ...
                      <td>
                        <div style="width: 200px;">
                          <?php if (!empty($data['mv_option'])) { ?>
                            <p style="color: #6777ef; font-size: 12px; font-weight: 500;"><strong><?= $data['material_name']; ?></strong>/<?= $data['mv_value']; ?></p>
                            <!-- <a href="<?php echo base_url() ?>owner/item_material/editmaterial/<?php echo $data['material_code']; ?>"><strong><?= $data['material_name']; ?></strong>/<?= $data['mv_value']; ?> </a> -->
                          <?php } else { ?>
                            <p style="color: #6777ef; font-size: 12px; font-weight: 500;"><strong><?= $data['material_name']; ?></strong></p>
                          <!--  <a href="<?php echo base_url() ?>owner/item_material/editmaterial/<?php echo $data['material_code']; ?>">
...
<script>
  ...
  function searchFilter(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>owner/inventory/ajaxPaginationData/'+page_num,

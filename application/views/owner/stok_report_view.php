      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="stok" role="tabpanel" aria-labelledby="stok-tab">
                <br>
                <form action="<?php echo site_url('owner/report/printinstock') ?>" method="post" enctype="multipart/form-data" >
                  <div class="form-row">
            ...
            <div class="tab-pane fade" id="mutasistok" role="tabpanel" aria-labelledby="mutasi-tab">
              <br>
              <form action="<?php echo site_url('owner/report/printoutstock') ?>" method="post" enctype="multipart/form-data" >
                <div class="form-row">
                  <div class="form-group col-md-4">
                    <label>Item Material</label>
          ...
          <div class="tab-pane fade" id="adjusment" role="tabpanel" aria-labelledby="adjust-tab">
            <form action="<?php echo site_url('owner/report/printrecapstock') ?>" method="post" enctype="multipart/form-data" >
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label>Item Material</label>
...
<script type="text/javascript">
  ...
  function filterInStockReport(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>owner/report/ajaxInStockReport/'+page_num,
  ...
  function filterOutStockReport(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>owner/report/ajaxOutStockReport/'+page_num,
  ...
  function filterRecapStockReport(page_num) 
  {
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>owner/report/ajaxRecapStockReport/'+page_num,

              ...
              <td>
                <div class="dropdown d-inline">
                  ...
                  <div class="dropdown-menu">
                    <a onclick="UpdateStatus('<?php echo base_url() ?>owner/purchase_order/updatestatusaccepted/<?php echo $data['id_det_po']; ?>')" class="dropdown-item has-icon" href="#!"><i class="fa fa-hourglass-start"></i>Sudah diterima</a>
                    <a onclick="UpdateStatus('<?php echo base_url() ?>owner/purchase_order/updatestatusnotaccepted/<?php echo $data['id_det_po']; ?>')" class="dropdown-item has-icon" href="#!"><i class="fa fa-check-circle"></i> Belum diterima</a>
                    <a onclick="UpdateStatus('<?php echo base_url() ?>owner/purchase_order/updatestatusreject/<?php echo $data['id_det_po']; ?>')"class="dropdown-item has-icon" href="#!"><i class="fa fa-times-circle"></i> Batalkan</a>
                  </div>
                </div>
              </td>
              <td>

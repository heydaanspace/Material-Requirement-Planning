...
<div class="text-md-right">
  <div class="float-lg-left mb-lg-0 mb-3">
    <a href="<?php echo base_url() ?>owner/purchase_order/newpo_recap_mrp/<?= $mrp_data->mo_id; ?>" class="btn btn-primary btn-icon icon-left"><i class="fas fa-credit-card"></i> Buat Rujukan Pemesanan Pembelian</a>
    <button class="btn btn-danger btn-icon icon-left"><i class="fas fa-times"></i> Cancel</button>
  </div>
  <a class="btn btn-warning" target="_blank" href="<?php echo base_url() ?>owner/mrp/pdfrecapmrp/<?= $mrp_data->mo_id; ?>"><i class="fas fa-print"></i> Print</a>
</div>
</div>
</div>
</section>

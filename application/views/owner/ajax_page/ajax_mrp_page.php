  ...
  <table class="table table-striped">
   ...
   <?php if(!empty($mrp_data)): foreach($mrp_data as $data): ?>
     <tr>
       ...
       <td><a class="badge badge-primary" href="<?php echo base_url() ?>owner/mrp/showdetailrecapmrp/<?= $data['mo_id']; ?>"><?= $data['mo_code'] ?></a></td> 
       <td>
      ...
      <td>
       <div class="false" style="text-align: center;">
        <a class="btn_td" href="<?php echo base_url() ?>owner/mrp/showdetailmrp/<?php echo $data['mrp_code']; ?>">Detail <i class="fa fa-eye"></i></a>
      </div>
    </td> 
  </tr>
<?php endforeach; else: ?>

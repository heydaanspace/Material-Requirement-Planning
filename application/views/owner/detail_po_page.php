  ...
  <div class="section-body">
    <div class="row">
      ...
      <div class="card-footer text-right">
        ...
        <button onclick="deleteConfirm('<?php echo base_url() ?>owner/purchase_order/actdeletePO/<?= $po_data->po_id; ?>')" class="btn btn-danger" type="button"><i class="fa fa-trash"></i> Hapus Draft PO</button>
      </div>
    </form>
  </div>
</div>

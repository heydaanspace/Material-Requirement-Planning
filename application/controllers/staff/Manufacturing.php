...
class Manufacturing extends MY_Controller
{
	public function __construct()
	{
		...
		$this->load->model("staff/manufacturing_model");
	...
	public function index()
	{
		...
		$data                      = $datapage + $conf;
		$this->template->load('staff/layout/template', 'staff/manufacturing_page',$data);
	}
	...
	public function ajaxPaginationData()
	{
		...
		$this->load->view('staff/ajax_page/ajax_manufacturing_order', $data, false);     
	...
	public function showitemproduct()
	{
		...
		$this->load->view('staff/modal_view/modal_view_item_product', $data);
	}
	...
	public function newmanufacturing()
	{
		...
		$this->template->load('staff/layout/template', 'staff/create_manufacturing', $alldata);
	}
	...
	public function addmanufacturingorder()
	{
		...
		if ($validation->run()) {
			...
			redirect('staff/manufacturing/newmanufacturing'); 
		}
	...
	public function editmanufacturing($mo_id = null)
	{
		...
		$this->template->load('staff/layout/template', 'staff/edit_manufacturing', $data);
	...
	public function UpdateStatusStart($mo_id = null)
	{
		...
		if ($this->manufacturing_model->StatusStart($mo_id)) 
		{
			...
			redirect(site_url('staff/manufacturing'));
		} else {
	...
	public function pdfinvoiceMO($mo_id = null)
	{
		...
		$this->pdfgenerator->load_view('staff/PDF_reporting/invoice_manufacturing_pdf', $data);
	}

...
class Inventory extends MY_Controller
{
	public function __construct()
	{
		...
		$this->load->model("owner/inventory_model");
	...
	public function index()
	{
		...
		$data                     = $datapage + $conf;
		$this->template->load('owner/layout/template', 'owner/inventory_page',$data);
	}
	...
	public function ajaxPaginationData()
	{
		...
		$this->load->view('owner/ajax_page/ajax_inventory_page', $data, false);     

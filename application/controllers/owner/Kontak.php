...
class Kontak extends MY_Controller
{
	public function __construct()
	{
		...
		$this->load->model("owner/konsumen_model");
		$this->load->model("owner/supplier_model");
...
//pagination conf.
	public function index()
	{
		...
		$this->template->load('owner/layout/template', 'owner/kontak_view', $data);
	...
	public function ajaxPaginationData()
	{
		...
		//load the view
		$this->load->view('owner/ajax_page/ajax_konsumen', $custdata, false);
	}
	...
	public function supajaxPaginationData()
	{
		...
		//load the view
		$this->load->view('owner/ajax_page/ajax_supplier', $supdata, false);
	}
...
//Customer crud
	public function custfrm()
	{
		...
		$this->template->load('owner/layout/template', 'owner/create_konsumen', $data);
	}
	...
	public function editkonsumen($customer_id = null)
	{
		...
		if ($validation->run()) {
			...
			$this->session->set_flashdata('msg', show_err_msg(validation_errors()));
			//redirect('owner/kontak/editkonsumen');
		...
		$data = $value + $conf;
		$this->template->load('owner/layout/template', 'owner/edit_konsumen', $data);
	}
	...
	public function delkonsumen($customer_id = null)
	{
		...
		if ($this->konsumen_model->delete($customer_id)) {
			...
			redirect(site_url('owner/kontak'));
		} else {
...
//supplier Crud
	public function supfrm()
	{
		...
		$this->template->load('owner/layout/template', 'owner/create_supplier', $data);
	}
	...
	public function editsupplier($supplier_id = null)
	{
		...
		$this->template->load('owner/layout/template', 'owner/edit_supplier', $data);
	}

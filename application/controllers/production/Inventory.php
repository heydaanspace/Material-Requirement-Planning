...
class Inventory extends MY_Controller
{
	public function __construct()
	{
		...
		$this->load->model("production/inventory_model");
	...
	public function index()
	{
		...
		$data                     = $datapage + $conf;
		$this->template->load('production/layout/template', 'production/inventory_page',$data);
	}
	...
	public function ajaxPaginationData()
	{
		...
		$this->load->view('production/ajax_page/ajax_inventory_page', $data, false);     

...
class Mrp extends MY_Controller
{
	public function __construct()
	{
		...
		$this->load->model("production/mrp_model");
	...
	public function index()
	{
		...
		$this->template->load('production/layout/template', 'production/mrp_page',$data);
	}
	...
	public function ajaxPaginationData()
	{
		...
		$this->load->view('production/ajax_page/ajax_mrp_page', $data, false);     
	...
	public function newmrp()
	{
		...
		$this->template->load('production/layout/template', 'production/create_mrp', $alldata);
	}
	...
	public function showproductmrp2()
	{
		...
		$this->load->view('production/ajax_create_mrp', $data, false);    
	}
	...
	public function showmaterial()
	{
		...
		$this->load->view('production/ajax_page/ajax_new_mrp', $data, false);  
	}
	...
	public function savemrp()
	{
		...
		if ($validation->run()) {
			...
			redirect('production/mrp/newmrp'); 
		}
	}
	...
	public function showdetailmrp($mrp_code = null)
	{
		...
		$this->template->load('production/layout/template', 'production/detail_mrp_page', $data);
	...
	public function showRecapPorel($mo_id = null)
	{
		...
		$this->template->load('production/layout/template', 'production/planned_order_releases', $data);
	...
	public function ActdeleteMRP($mrp_id = null)
	{
		...
		if ($this->mrp_model->deleteMRP($mrp_id)) 
		{
			...
			redirect(site_url('production/mrp'));
		} else {
	...
	public function pdfrecapMRP($mo_id = null)
	{
		...
		$this->pdfgenerator->load_view('production/PDF_reporting/recap_porel_pdf', $data);
	}
